      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h1 class="mb-0 bread">PAYOUT SUMMARY OF EMPLOYEE</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="col-md-4 py-md-5 py-4 aside-stretch-right pl-lg-6">
			...
			<form method="POST" class="contact-form">
        		<div class="form-group">
				  ...
				  <div class="form-group">
					<input type="submit" class="form-control submit px-3" name="empsalmonth" value="Employee Monthly salary" formaction="monsalemp.php">
			   </div>
			   <!-- <div class="form-group">
					<button type="submit" class="form-control submit px-3" name="ViewCompanyRecord" formaction="maps.php" ></button>
				</div> -->
		    </form>
