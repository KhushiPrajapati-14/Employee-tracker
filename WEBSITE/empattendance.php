   				...
   				<table class="table table-hover">
						...
						<?php
							...
							while($res = mysqli_fetch_array($query)){
								...
								//(($res['Time']>="04:18:00" && $res['Time']<="12:00:00") && $res['LocationLatitude']==19.0947917 && $res['LocationLongitude']==72.8425933)

									($res['LocationLatitude']==19.0947917 && $res['LocationLongitude']==72.8425933)
								{
									$attendance="Present";
								}
								else
