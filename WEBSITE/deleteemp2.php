...
<?php 	
			   ...
			   if(isset($_POST['View']))
			   {
					$id1=$_POST['EmployeeID2'];
					$query="SELECT * FROM webtable WHERE EmployeeID='$id1'";
                ...
                <div class="form-group">
                	Employee ID :<input type="text" class="form-control" id="EmployeeID" name="EmployeeID" placeholder="Employee ID" value="<?php echo $row['EmployeeID']; ?>" >
				  </div>
              	<div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="form-group">
					<input type="submit" class="form-control submit px-3" name="DeleteEmployee" value="Delete Employee">
			  </div>
              <div class="form-group">
					<button type="submit" class="form-control submit px-3" name="Back" formaction="deleteemp.php" >Back</button>
				</div>
				</form>
				...
				if($exist==False){
					...
					<script src="js/sweetalert.js"></script>
					  ...
					  swal("Employee cannot be deleted!","Employee Id does not exists", "error").then(function() {
							window.location = "deleteemp.php";
										  });
                 ...
                 {
                     $id=$_POST['EmployeeID'];
                     $idquery="SELECT * FROM webtable where EmployeeID='$id' ";
                     $query=mysqli_query($con,$idquery);
                     $idcount=mysqli_num_rows($query);
                     if($idcount>0)
                     {
                          $query1 = "DELETE FROM webtable WHERE EmployeeID = $id ";
                        ...
                        { 
                          ...
                          <script src="js/sweetalert.js"></script>
                            ...
                            swal("Employee Deleted!"," ", "success").then(function() {
                                  window.location = "deleteemp.php";
                                                });
