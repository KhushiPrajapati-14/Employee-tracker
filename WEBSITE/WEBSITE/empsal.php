	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item"><a href="empattendance.php" class="nav-link">Employee Attendances</a></li>
	        	<li class="nav-item"><a href="addemp.php" class="nav-link">Add An Employee</a></li>
