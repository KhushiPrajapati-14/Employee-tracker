     ...
     <script>
        function initMap() {
            ...
            var myLatLng = {
                ...
                lng: <?php echo $res_2['Task1Longitude']; ?>
               
            };
            var myLatLng_1 = {

                lat: <?php echo $res_1['Task2Latitude']; ?>,
                lng: <?php echo $res_2['Task2Longitude']; ?>

            };
            var myLatLng_2 = {

                lat: <?php echo $res_1['Task3Latitude']; ?>,
                lng: <?php echo $res_2['Task3Longitude']; ?>

            };
            var myLatLng_3 = {

                lat: <?php echo $res_1['Task4Latitude']; ?>,
                lng: <?php echo $res_2['Task4Longitude']; ?>
            ...
            <?php if($res_1['Task1Latitude']!=0 && $res_2['Task1Longitude']!=0) {
                ?>
                    new google.maps.Marker({
                        position: myLatLng,
                        map,
                        title: "Task 1 location",
                    });
            <?php 
            }
            if($res_1['Task2Latitude']!=0 && $res_2['Task2Longitude']!=0) {
                ?>
                    new google.maps.Marker({
                        position: myLatLng_1,
                        map,
            ...
            if($res_1['Task3Latitude']!=0 && $res_2['Task3Longitude']!=0) {
                ?>
                    new google.maps.Marker({
                        position: myLatLng_2,
                        map,
                        title: "Task 3 location",
                    });
            <?php 
            }if($res_1['Task4Latitude']!=0 && $res_2['Task4Longitude']!=0) {
                ?>
                    new google.maps.Marker({
                        position: myLatLng_3,
                        map,
                        title: "Task 4 location",
                    });
            <?php 
            }
