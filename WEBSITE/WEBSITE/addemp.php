    ...
    <footer class="footer">
		...
		<div class="col-md-4 py-md-5 py-4 aside-stretch-right pl-lg-6">
				...
				if(isset($_POST["submit"]))
				{
					...
					{ 
						...
						if(strlen($EmployeeName) >= 2 && strlen($EmployeeName) <=40)
						{
							...
							else{ $msg .="Employee name can contain only alphabets. "; }
						}else{ $msg .="Employee name must be between 2 to 40 characters long."; }  
						...
						else { $msg.=" Password must be between 6 to 20 characters long."; }
			...
			<form method="POST" enctype="multipart/form-data" class="contact-form">
				...
				<div class="form-group">
                	<input type="text" class="form-control" id="Salary" name="Salary" required placeholder="Salary(Per Day)">
				</div>  
              	<div class="form-group">
