      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h1 class="mb-0 bread">Payroll Summary</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="col-md-4 py-md-5 py-4 aside-stretch-right pl-lg-6">
			...
			<form method="POST" class="contact-form">
				  ...
				  <div class="form-group">
					<input type="submit" class="form-control submit px-3" name="Empmonthsal" value="Payroll Summary of Employee" formaction="monsal.php">
			   </div>

				  <div class="form-group">
					<input type="submit" class="form-control submit px-3" name="halfyearsal" value="Payroll Summary of company(1 year)" formaction="compsales1y.php">
			   </div>

               <div class="form-group">
					<input type="submit" class="form-control submit px-3" name="yearsal" value="Payroll Summary of company(6 months)" formaction="compsales6m.php">
			   </div>
		    </form>
